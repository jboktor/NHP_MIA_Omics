...
total_lib_fake <- seq(from = 50, to = 1000, by = 25)
total_sig_lib_fake <- seq(from = 0, to = 500, by = 10)
path_lib_fake <- seq(from = 0, to = 150, by = 10)
...
ggsave(simulated_data_plot,
  filename = "figures/correlations/enrichment_simulations.png",
  width = 12, height = 12
)
