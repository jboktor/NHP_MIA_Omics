...
ggsave(pcoa_stool,
  filename = "figures/16S/beta-diversity/stool_unifrac_pcoa.svg",
  width = 7, height = 3
)
ggsave(pcoa_jej,
  filename = "figures/16S/beta-diversity/jejunum_unifrac_pcoa.svg",
  width = 7, height = 3
)
ggsave(pcoa_ile,
  filename = "figures/16S/beta-diversity/ileum_unifrac_pcoa.svg",
  width = 7, height = 3
)
