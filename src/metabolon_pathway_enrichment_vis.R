...
pthways <- read_xlsx("input_files/pathway_map.xlsx", sheet = "Sheet 1") %>%
  ...
  select(Superpathway, Subpathway) %>%
  distinct()
...
barplot_sums <- function(df, xlab, plot_title) {
  df %>%
    ...
    ggplot() +
    geom_col(aes(
      y = factor(tissue_source, level = tissues),
...
ggsave(FIG_3A,
  filename = paste0("figures/pathway_enrichment/FIG_3A.svg"),
  height = 2.5, width = 7
)
ggsave(FIG_4A,
  filename = paste0("figures/pathway_enrichment/FIG_4A.svg"),
  height = 2.5, width = 6.5
)
ggsave(FIG_5A,
  filename = paste0("figures/pathway_enrichment/FIG_5A.svg"),
  height = 3.5, width = 8
)
ggsave(FIG_5D,
  filename = paste0("figures/pathway_enrichment/FIG_5D.svg"),
  height = 2.5, width = 7.5
)
ggsave(FIG_S9A,
  filename = paste0("figures/pathway_enrichment/FIG_S9A.svg"),
  height = 3, width = 8
)

# Subpathways summarized across tissues
FIG_1C <- barplot_subpath_all_tissues(
  enrichment_treatment,
  xlab = "Sum mated Enrichment Score Poly(I:C)/Control", plot_title = " "
)
FIG_S1A <- barplot_subpath_all_tissues(
  enrichment_M_treatment,
  xlab = "Summated Enrichment Score Poly(I:C)/Control",
  plot_title = "Metabolic Pathway Enrichment in Male Treatment Condition"
)
FIG_S1B <- barplot_subpath_all_tissues(
  enrichment_F_treatment,
  xlab = "Summated Enrichment Score Poly(I:C)/Control",
  plot_title = "Metabolic Pathway Enrichment in Female Treatment Condition"
)

ggsave(FIG_1C,
  filename = paste0("figures/pathway_enrichment/FIG_1C.svg"),
  height = 5, width = 8
)
ggsave(FIG_S1A,
  filename = paste0("figures/pathway_enrichment/FIG_S1A.svg"),
  height = 5, width = 8
)
ggsave(FIG_S1B,
  filename = paste0("figures/pathway_enrichment/FIG_S1B.svg"),
  height = 5, width = 8
)
